...
public abstract class BaseResourceRepositoryConfigurationValidator<TRepository>
    : IResourceRepositoryConfigurationValidator where TRepository : IResourceRepository
{
